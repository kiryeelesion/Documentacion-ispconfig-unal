...
En caso de no ver los botones de ***Make backup of databases*** y ***Make backup of web files*** podemos generar la copia acudiendo a *Intervalo de copia de seguridad* del menú, seleccionando una opción.
